...
export const THEMES: Themes = {
  light: {
    ...
    shadows: {
      ...
      accent:
        '-5.0934px -5.0934px 15.2802px rgba(255, 255, 255, 0.5), 5.0934px 5.0934px 15.2802px #25CEDE;',
    },
  },
  dark: {
    colors: {
    ...
    shadows: {
      button: '-6.22302px -6.22302px 18.6691px #3B4451, 6.22302px 6.22302px 18.6691px #000000;',
      input:
